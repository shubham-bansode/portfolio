...
function initContactForm() {
    ...
    try {
        // Initialize once; safe to call multiple times but guard is simple
        emailjs.init('sm08AnEPv9i2Vfjzu'); // Public key
    } catch (e) {
        console.warn('EmailJS init failed or already initialized:', e?.message || e);
    }
    ...
    form.addEventListener('submit', function (e) {
        ...
        emailjs.sendForm('service_jtnlzjh', 'template_1g0ebr8', form)
            .then(() => {
